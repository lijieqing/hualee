...
import hua.lee.springboot.modal.vo.OptionVo;
import hua.lee.springboot.service.ILogService;
import hua.lee.springboot.service.IOptionService;
import hua.lee.springboot.service.ISiteService;
import hua.lee.springboot.util.GsonUtils;
...
public class SettingController extends AbstractController {
    ...
    public String index(HttpServletRequest request) {
        ...
        if (null == options.get("site_record")) {
