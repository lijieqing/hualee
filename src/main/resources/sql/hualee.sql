...
-- 创建数据库
create database `hualee` default character set utf8 collate utf8_general_ci;
...
VALUES
	(1, 'admin', 'bf42d9b328aa6f639ed2871adaf9b106', '759353118@qq.com', NULL, 'admin', 15853889779, 0, 0, 'visitor');
