...
$(document).ready(function () {
    ...
    if ($('#thumb-toggle').attr('thumb_url') != '' && $('#thumb-toggle').attr('thumb_url')!= undefined) {

        console.log("url -> "+ $('#thumb-toggle').attr('thumb_url'));
...
function add_thumbimg(obj) {
    ...
    if (on == 'true') {
        ...
        var thumburl = this_.attr('thumb_url');
        $('#thumbImg').val(thumburl);
        $('#dropzone-container').show();
    } else {
        this_.attr('on', 'true');
